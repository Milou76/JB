        ...
        const tableauDonnees1 = [
            { code: "1.1", activite: "Rechercher l'information technique", bold: true, connaissances: "" },
            ...
            { code: "1.2", activite: "Décoder l'information technique", bold: true, connaissances: "" },
            ...
            { code: "2.1", activite: "Choisir le matériel, les équipements et les produits.", bold: true, connaissances: "" },
        ...
        { code: "2.2", activite: "Organiser son poste de travail.", bold: true, connaissances: "" },
        ...
        { code: "2.2.7", activite: "•Prendre en compte le principe de la marche en avant.", connaissances: "Indication des règles d'utilisation, de sécurité et d'entretien des matériels utilisés." },
            ...
            { code: "3.3", activite: "Entretien des locaux et des équipements", bold: true, connaissances: "" },
        ...
        { code: "3.4", activite: "Entretien du linge et des vêtements", bold: true, connaissances: "" },
        ...
        { code: "3.4.4", activite: "•Effectuer des travaux de réfection courants (coudre un bouton, ourlet, assemblage…).", connaissances: "Description des documents professionnels et courants (fiche de stock, bon de commande, fiche de traçabilité…)." },
            ...
            { code: "4.1", activite: "Transmettre des informations à caractère professionnel à l'écrit ou à l'oral :", bold: true, connaissances: "" },
        ...
        { code: "4.2", activite: "Entretien du linge et des vêtements", bold: true, connaissances: "" },
